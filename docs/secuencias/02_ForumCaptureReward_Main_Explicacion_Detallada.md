...
La Sequence comprueba aproximadamente cada 0,75 segundos si alguno de los Foros registrados ha sido conquistado.

En condiciones normales, la recompensa aparece como máximo unos 750 ms después de que el cambio de propietario sea visible para la Sequence.
...
pueden generar sus recompensas dentro del mismo ciclo del bucle.

No existe un estado global que limite la Sequence a una única recompensa activa.
...
conserva sus referencias
        ↓
vigila cambios de propietario cada 750 ms
        ↓
